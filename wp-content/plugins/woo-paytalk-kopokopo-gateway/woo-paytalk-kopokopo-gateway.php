...
Description: KopoKopo Lipa Na Mpesa uses paytalk gateway that allows woocommerce users to accept payment from Mpesa customers.
Version: 2.0.7
...
function init_kopokopo_class() {
    class WC_Paytalk_KopoKopo_Gateway extends WC_Payment_Gateway {
    	function __construct() {
			...
			$this->method_description = __('Paytalk KopoKopo gateway works by adding form fields on the checkout page and then sending the details to Paytalk.co.ke for verification and processing. Get API keys from <a href="https//developer.paytalk.co.ke">developer.paytalk.co.ke</a>', 'woocommerce');
		...
		function init_form_fields() {
			...
			$this->form_fields = array(
				...
				'trans_key' => array(
					...
					'type'        => 'password',
					'description' => __( 'Your API credentials can be located in your PayTalk developer account.', 'woocommerce' ),
					'default'     => ''
					)
			);
